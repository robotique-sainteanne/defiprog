...
def part_4(text: str):
    ...
    for number in range(highestLength):
        try:
            letter1 = words[0][number]
        except:
            letter1 = " "
        try:
            letter2 = words[1][number]
        except:
            letter2 = " "
        try:
            letter3 = words[2][number]
        except:
            letter3 = " "
        try:
            letter4 = words[3][number]
        except:
            letter4 = " "
        try:
            letter5 = words[4][number]
        except:
            letter5 = " "
        cascade.append(f"{blankText * number}{letter1} {letter2} {letter3} {letter4} {letter5}")
